...
BlocklyStorage.backupBlocks = function(workspace) {
  if ('localStorage' in window) {

    if (confirm("Are you sure you want to overwrite your previous save?")) {
...
BlocklyStorage.backupOnUnload = function(opt_workspace) {
  ...
  window.addEventListener('unload',
      function() {BlocklyStorage.backupBlocks(workspace);}, false);
};
